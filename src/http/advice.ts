...
class AdviceService {
  ...
  static async updateAdvice(id: number, adviceData: Partial<AdviceRequest>): Promise<AdviceResponse> {
    try {
  ...
  static parseAdviceItems(itemsJson: string): Array<{title: string, description: string, example: string}> {
    try {
  ...
  static stringifyAdviceItems(items: Array<{title: string, description: string, example: string}>): string {
    try {
