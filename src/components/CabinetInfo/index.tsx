...
const CabinetInfo = ({ setPatient, patient }: CabinetInfoProps) => {
  ...
  const handleAvatarPress = () => {
    Alert.alert("Сменить аватар", "Выберите действие", [
      {
  ...
  return (
    <View style={styles.wrapper}>
        ...
        <View style={styles.main}>
          <TouchableOpacity onPress={handleAvatarPress} disabled={isLoading}>
            <Image
              ...
              source={patient?.avatar ? { uri: patient.avatar } : MockImage}
              alt="Avatar"
              resizeMode="contain"
            />
          </TouchableOpacity>
      ...
      >
        <TouchableOpacity style={styles.modalOverlay} activeOpacity={1} onPress={closeTooltip}>
          <View
            style={[
              styles.tooltip,
              {
